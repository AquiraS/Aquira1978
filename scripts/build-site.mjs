...
const english = {
  siteDescription: "This is the official website for records concerning the origin of the name Aquira, its history, archive, and use of the brand.",
  role: {
    eyebrow: "ORIGIN & ARCHIVE",
    title: "The origin of a name, and a record of a journey.",
    lead: "Aquira1978 is the official website for records concerning the origin of the name Aquira, its history, archive, and use of the brand. Information on works and the artist is available at aquira.art; projects for dialogue and collaboration are presented at aquira.org.",
  },
  purpose: [
    ...
    ["Preserving the record", "Where they can be made public, we add dates, context and references, gradually developing an archive that can be consulted later."],
    ["Providing a point of contact for use", "For enquiries about use of the name Aquira or its official forms, we will direct you to the appropriate contact after confirming the intended use and where it will appear."],
  ],
  archive: [
